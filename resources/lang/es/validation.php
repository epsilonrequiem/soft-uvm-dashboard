...
return [
    ...
    */
    ...
    | la convención "atributo.regla" para nombrar las líneas. Esto facilita
    | especificar un mensaje personalizado para una regla específica.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas se usan para intercambiar el marcador de posición
    | del atributo por algo más legible como "Correo Electrónico" en lugar
    | de "email". Esto ayuda a que el mensaje sea más claro.
    |
    */
